...
if __name__ == '__main__':
    ...
    save_model_dir = os.path.join(path_model + '/save_model', 'pre_trained_car')
    # initializing second
    calib_path = '/media/sverma/TOSHIBA EXT/pp_git/pointpillars/000000.txt'
    config_path = '/media/sverma/TOSHIBA EXT/pp_git/pointpillars/car.config'
    ckpt_path = '/media/sverma/TOSHIBA EXT/pp_git/pointpillars/voxelnet-306640.tckpt'
    proc = Processor_ROS(calib_path, config_path, ckpt_path)
    proc.initialize()
